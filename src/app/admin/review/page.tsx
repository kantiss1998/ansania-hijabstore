...
export default function AdminReviewPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="card p-4 flex justify-between items-center border border-gray-100">
          <span className="text-sm text-gray-500">Halaman {page} dari {totalPages} ({total} ulasan)</span>
          <div className="flex gap-2">
            <button
              disabled={page <= 1}
