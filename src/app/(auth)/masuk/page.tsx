...
export default function LoginPage() {
  ...
  const handleFacebookLogin = () => {
    toast.error('Facebook Login dinonaktifkan sepenuhnya oleh sistem keamanan.');
  };
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2.5 py-3 px-4 border border-black/10 rounded-xl font-display font-bold uppercase text-[10px] tracking-wider text-gray-700 hover:border-black/20 hover:bg-gray-50 transition-all cursor-pointer"
            >
